...
use NS\SearchBundle\Model\ArticleSearch;
...
class ArticleController extends Controller
{
    public function exportAction(Request $request)
    {
        ...
        $articleIndex = $this->get('fos_elastica.index.ns_search.article');
        ...
        $articleTransformer = $this->get('ns.transformers.elastica.article');
    ...
    public function listAction(Request $request, $page)
    {
        ...
        $articleSearchForm = $this->get('form.factory')
            ->createNamed(
                ...
                $articleSearch,
                array(
                    'action' => $this->generateUrl('ns-article-search'),
                    'method' => 'GET'
                )
            );
        ...
        return $this->render('NSSearchBundle:Article:list.html.twig', array(
    ...
    public function statsAction(Request $request)
    {
        ...
        $articleSearchForm = $this->get('form.factory')
            ->createNamed(
                ...
                $articleSearch,
                array(
                    'action' => $this->generateUrl('ns-article-stats'),
                    'method' => 'GET'
                )
            );
        $articleSearchForm->handleRequest($request);
        ...
        $results = $this->get('fos_elastica.index.ns_search.article')->search($query);

        return $this->render('NSSearchBundle:Article:stats.html.twig', array(
    ...
    protected function getSearchRepository()
    {
        return $this->container
            ...
            ->getRepository('NSSearchBundle:Article')
        ;
    }
}
